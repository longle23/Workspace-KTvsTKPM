...
//	1. Cho biết các chuyến bay đi Đà Lạt (DAD).
	@Test
	void testCau1() {
		List<ChuyenBay> chuyenBays = chuyenBayService.findByGaDen();
...
//	@Test
//	void testCau19() {
//		List<Object[]> objects =  chuyenBayService.tongChiPhiPhaiTra();
//		System.out.println("Với mỗi ga có chuyến bay xuất phát từ đó cho biết tổng chi phí phải trả cho phi công lái các \n"
//				+ "chuyến bay khởi hành từ ga đó.");
//		for (Object[] objects2 : objects) {
...
//	@Test
//	void testCau20() {
//		List<ChuyenBay> chuyenBays = chuyenBayService.findCBKHTruoc12h();
//		System.out.println("danh sách các chuyến bay có thể khởi hành trước 12:00: ");
//		for (ChuyenBay chuyenBay : chuyenBays) {
//			System.out.println(chuyenBay);
//		}
//	}
...
//	@Test
//	void testCau21() {
//		List<Object[]> objects =  chuyenBayService.countDiaDiemKhoiHanhTruoc12h();
//		System.out.println("Với mỗi địa điểm xuất phát cho biết có bao nhiêu chuyến bay có thể khởi hành trước 12:00.");
//		for (Object[] objects2 : objects) {
//			System.out.println("Ga di: " + objects2[0] + ", So luong chuyen bay: " + objects2[1]);
//		}
//	}
